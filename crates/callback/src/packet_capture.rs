...
const IOCTL_DIOPROCESS_PACKET_START_CAPTURE: u32 = 0x00224000; // CTL_CODE(0x22, 0x900, 0, 0)
const IOCTL_DIOPROCESS_PACKET_STOP_CAPTURE: u32 = 0x00224004;  // CTL_CODE(0x22, 0x901, 0, 0)
const IOCTL_DIOPROCESS_PACKET_GET_PACKETS: u32 = 0x00224008;   // CTL_CODE(0x22, 0x902, 0, 0)
const IOCTL_DIOPROCESS_PACKET_INJECT: u32 = 0x0022400C;        // CTL_CODE(0x22, 0x903, 0, 0)
const IOCTL_DIOPROCESS_PACKET_ADD_FILTER: u32 = 0x00224010;    // CTL_CODE(0x22, 0x904, 0, 0)
const IOCTL_DIOPROCESS_PACKET_REMOVE_FILTER: u32 = 0x00224014; // CTL_CODE(0x22, 0x905, 0, 0)
const IOCTL_DIOPROCESS_PACKET_CLEAR_FILTERS: u32 = 0x00224018; // CTL_CODE(0x22, 0x906, 0, 0)
const IOCTL_DIOPROCESS_PACKET_CLEAR_BUFFER: u32 = 0x0022401C;  // CTL_CODE(0x22, 0x907, 0, 0)
const IOCTL_DIOPROCESS_PACKET_GET_STATE: u32 = 0x00224020;     // CTL_CODE(0x22, 0x908, 0, 0)
