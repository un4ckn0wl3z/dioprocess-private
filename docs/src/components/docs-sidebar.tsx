...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Network Monitoring", href: "/docs/usermode/network-monitoring", icon: Network },
      { title: "Service Management", href: "/docs/usermode/service-management", icon: Settings },
      ...
      { title: "String Scanning", href: "/docs/usermode/string-scanning", icon: FileSearch },
      { title: "Token Theft", href: "/docs/usermode/token-theft", icon: Key },
      { title: "AMSI & ETW Bypass", href: "/docs/usermode/amsi-etw-bypass", icon: ShieldOff },
    ],
  },
  {
    title: "Utilities",
    ...
    icon: Wrench,
    items: [
      { title: "File Bloating", href: "/docs/utilities/file-bloating", icon: FileUp },
      { title: "Ghostly Hollowing", href: "/docs/utilities/ghostly-hollowing", icon: Ghost },
      { title: "Herpaderping", href: "/docs/utilities/herpaderping", icon: Layers },
    ],
  },
  {
    title: "Kernel Driver",
    ...
    items: [
      ...
      { title: "Debug Flags", href: "/docs/kernel/debug-flags", icon: Bug },
      { title: "Memory Dump", href: "/docs/kernel/memory-dump", icon: HardDriveDownload },
      { title: "Kill Methods", href: "/docs/kernel/kill-methods", icon: Skull },
      { title: "Packet Capture", href: "/docs/kernel/packet-capture", icon: Radio },
      { title: "ETWTI Bypass", href: "/docs/kernel/etwti-bypass", icon: ShieldBan },
    ],
  },
  {
    title: "Kernel Enumeration",
    href: "/docs/kernel-enumeration",
    icon: List,
    items: [
      { title: "PspCidTable", href: "/docs/kernel-enumeration/pspcidtable", icon: Database },
      { title: "Minifilters", href: "/docs/kernel-enumeration/minifilters", icon: Filter },
      { title: "Driver Enumeration", href: "/docs/kernel-enumeration/drivers", icon: HardDrive },
      { title: "Registry Callbacks", href: "/docs/kernel-enumeration/registry-callbacks", icon: FileCode },
    ],
  },
  {
    title: "Kernel Hiding",
    href: "/docs/kernel-hiding",
    icon: EyeOff,
    items: [
      { title: "Process Hiding (DKOM)", href: "/docs/kernel-hiding/process-hiding", icon: EyeOff },
      { title: "File Hiding", href: "/docs/kernel-hiding/file-hiding", icon: FolderClosed },
      { title: "Port Hiding", href: "/docs/kernel-hiding/port-hiding", icon: Network },
    ],
  },
  {
    title: "Hypervisor",
    ...
    items: [
      ...
      { title: "Register Hooks", href: "/docs/hypervisor/register-hooks", icon: Variable },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Boot Animation", href: "/docs/uefi/boot-animation", icon: Play },
      { title: "NVRAM Config", href: "/docs/uefi/nvram-config", icon: Cog },
      { title: "ESP Management", href: "/docs/uefi/esp-management", icon: HardDrive },
    ],
  },
  {
    title: "SDK",
